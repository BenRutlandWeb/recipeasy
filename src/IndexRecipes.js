...
function buildSearchIndex() {
    ...
    fs.writeFileSync(path.resolve(__dirname, "./data/recipes-search.json"), JSON.stringify(output, null, 2));
}
...
function buildListings() {
    ...
    fs.writeFileSync(path.resolve(__dirname, "./data/recipes.json"), JSON.stringify(output, null, 2));
}
